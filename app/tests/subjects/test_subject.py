...
class SubjectTestCase(TestCase):
    ...
    def test_load_call_graph(self):
        ...
        self.assertRaises(
            errors.SubjectNotPreparedError,
    ...
    def test_get_absolute_path(self):
        ...
        self.assertEqual(
            os.path.join(subject.__source_dir__, 'main.c'),
            subject.get_absolute_path('main.c')
        )

        self.assertEqual(
            os.path.join(subject.__source_dir__, 'main'),
    ...
    def test_execute(self):
        ...
        return_code = subject.__execute__(['echo', 'nocturnal'], cwd='/')
        self.assertEqual(0, return_code)

        return_code = subject.__execute__(['exit 2'], cwd='/')
