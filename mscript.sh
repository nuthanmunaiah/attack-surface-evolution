...
cd $scratch_root/$subject/${directories[${SLURM_ARRAY_TASK_ID}]}
mkdir gprof
cd $scratch_root/$subject/${directories[${SLURM_ARRAY_TASK_ID}]}/src
mkdir gmon
...
curl https://5751f28e22fbde2d8ba3f9b75936e0767c761c6a.googledrive.com/host/0B1eWsh8KZjRrfjg0Z1VkcU96U2hQal9scHM3NzVmYTk2WVhiQzQtdGFpNWc5c0VzbUJFTE0/$subject/Patches/${releases[${SLURM_ARRAY_TASK_ID}]}.FFmpeg.patch > patch.patch
