...
declare -a directories=(
    "b67cc06dc06c7862a589d5e6c9974fc6" "a65bc9a708796630eab302f645bee2e7"
    "7d85e078b2d2ce24a50c620ed1236cd1" "0734ef679b1f63aa29789f557d3b38df"
    "883ee5600a6d23c91ecfc34844092ce6" "a43a1cdd71b1b011d8aedeb8dfb16cb4"
    "f6a90866c4636b92067ffacd2a0ed236" "7525445f938a780b6356d7bf08f5076a"
    "0dbabe0f49a2124771d6d643bb8b239e" "d9071a3d45b5692e60ba692055efb817"
    "4be74df405ae9bcdee59a7e6695c02d1" "e7c771df9ff2cf5d22f9ddaac8119772"
    "5a537d3de18d5e7a93ef671075683023" "536825000d75d835c27f3f9e285a0ced"
    "8ed1a028cb466dc41249de6f6c27b560" "8aa456880740245badac49bf7fed3cb4"
)
declare -a releases=(
...
if [ "$#" -eq 1 ]; then
    ...
    echo "Running manual script for release ${releases[${SLURM_ARRAY_TASK_ID}]}"
fi
